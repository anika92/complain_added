...
<div class="view">
    <div class="row" >
        ...
        <div class="col-lg-12">
            <h1 class="page-header" align="center"><?php echo $singleView->name  ?> You Can Edit Your Profile From Here</h1>
        </div>
        ...
        <div class="table-bordered" style="border: solid gray">
            ...
            <form role="form" action="update.php" method="post" enctype="multipart/form-data">
                <div class="thumbnail">
                    <img class="img-responsive" src="../../Resources/images/users/<?php echo $singleView->image?>" alt="" height="300px" width="400px">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                    <input type="text" name="id" style="display: none" value="<?php echo $singleView->user_id ?>">
                    <tr><td>Name:</td><td>
                        ...
                        <td> <div class="form-group">
                                ...
                                <select name="thana" class="form-control">
                                    <?php foreach($all_station as $station){ ?>
                                        <option value="<?php $station->station_id ?>">
