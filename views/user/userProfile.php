...
$profile =new User();
$user_profile=$profile->prepare($_GET)->userview();
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="../../views/criminal_info/addcriminal.php">Add Criminal</a>
                    </li>
                    <li>
                        <a href="../../views/criminal_info/mostwanted_index.php">View Most Wanted Criminals</a>
                    </li>
...
<div class="view">
    <div class="row" >
        ...
        <div class="col-lg-12">
            <h1 class="page-header" align="center">Hi!! <?php echo $user_profile->name ?> This is Your Profile </h1>
        </div>
        ...
        <div class="table-bordered" style="border: solid gray">
            <br>
            <div class="thumbnail">
                <img class="img-responsive" src="../../Resources/images/users/<?php echo $user_profile->image?>" alt="" height="300px" width="400px">
            </div>
            ...
            <table class="table table-striped">
                ...
                <tr><td>Email:</td> <td><?php echo $user_profile->email?></td></tr>
                <tr><td>Password:</td> <td></td></tr>
                <tr><td>Police Code:</td> <td><?php echo $user_profile->phone?></td></tr>
                <tr><td>NID:</td> <td><?php echo $user_profile->nid?></td></tr>
                <tr><td>Address:</td> <td><?php echo $user_profile->address?></td></tr>
                <tr><td>City:</td> <td><?php echo $user_profile->city?></td></tr>
                <tr><td>Thana:</td> <td><?php echo $user_profile->thana?></td></tr>


                <tr><td>Postal:</td> <td><?php echo $user_profile->postal?></td></tr>
                <tr><td>Gender:</td> <td><?php echo $user_profile->gender?></td></tr>
                <tr><td>Phone:</td> <td><?php echo $user_profile->phone?></td></tr>
            ...
            <div class="thumbnail text-center">
                <a href="user_edit.php?id=<?php echo $user_profile->user_id?>" class="btn btn-primary btn-lg" role="button">Update</a>&nbsp
                <a href="welcome.php" class="btn btn-primary btn-lg" role="button">Back</a>
            </div>
        </div>
