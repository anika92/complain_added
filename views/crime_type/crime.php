    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar">
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="../admin/policeall.php">View List</a></li>
                            <li><a href="../admin/station.php">Add Station</a></li>
                            <li><a href="../admin/police_add.php">Add Police</a></li>
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="../admin/crimeall.php">View List</a></li>
                            <li><a href="../crime_type/crime.php">Manage Crime</a></li>
                            <li><a href="../admin/criminal_add.php">Manage Criminals</a></li>
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="../admin/userall.php">View List</a></li>
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="../admin/missingall.php">View List</a></li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                ?>
                <?php include_once('crimeType.php') ?>
                <br/>
                <br/>
                <?php include_once('criminalType.php') ?>
