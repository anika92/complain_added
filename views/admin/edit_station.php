...
if($status == TRUE) {
    ...
    $single= $station->prepare($_GET)->viewstation();
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <form class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post" action="update_station.php"><div class="title"><h2>Criminal Table</h2></div>
                    <input style="display: none;" class="large" type="text" name="id" value="<?php echo $single->station_id ?>"/>

                    <div class="element-input">
                        <label class="title">
                            <span class="required">*</span></label>
                        <div class="item-cont">
                            <input class="large" type="text" name="police_station" required="required" value="<?php echo $single->station_name ?>"/>
