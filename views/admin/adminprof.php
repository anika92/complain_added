        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                <ul class="list-group">
                                    <li class="list-group-item"><h3>Name : <?php echo $a_profile->name?></h3></li>
                                    <li class="list-group-item">Email : <?php echo $a_profile->email?></li>
                ...
                <div class="text-center">
                    <a href="adminprof_edit.php?id=<?php echo $a_profile->id?>" class="btn btn-primary btn-lg" role="button">Update</a>&nbsp
                </div>
