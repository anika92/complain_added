...
if($status == TRUE) {
    ...
    $profile = new User();
    $user = $profile->prepare($_GET)->userview();
            ...
            <section class="content">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="thumbnail">
                            <img class="img-responsive" src="../../Resources/images/users/<?php echo $user->image?>" alt="" height="200px" width="200px">

                            <div class="caption">
                                <ul class="list-group">
                                    <li class="list-group-item"><h3>Name : <?php echo $user->name?></h3></li>
                                    <li class="list-group-item">Email : <?php echo $user->email?></li>
                                    <li class="list-group-item">NID : <?php echo $user->nid?></li>
                                    <li class="list-group-item">Thana/PS : <?php echo $user->thana?></li>
                                    <li class="list-group-item">City : <?php echo $user->city?></li>
                                    <li class="list-group-item">Address : <?php echo $user->address?></li>
                                    <li class="list-group-item">Postal : <?php echo $user->postal?></li>
