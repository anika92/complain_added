            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="thumbnail">
                            <img class="img-responsive" src="../../Resources/images/criminals/<?php echo $singleView->image?>" alt="" height="200px" width="200px">

                            <div class="caption">
                                <ul class="list-group">
                                    <li class="list-group-item"><tr><td>Name:</td> <td><?php echo $singleView->name?></td></tr></li>
                                    <li class="list-group-item"><tr><td>Description:</td> <td><?php echo $singleView->description?></td></tr></li>
                                    <li class="list-group-item"><tr><td>Crime Type</td><td><?php echo $singleView->crime_type?></td></tr>
                                    <li class="list-group-item"> <tr><td>Criminal Type:</td><td><?php echo $singleView->c_t_type ?></td></tr></li>
                                    <li class="list-group-item"><tr><td>Age:</td> <td><?php echo $singleView->age?></td></tr></li>
                                    <li class="list-group-item"><tr><td>Height:</td> <td><?php echo $singleView->height?></td></tr></li>
                                    <li class="list-group-item"><tr><td>Gender:</td> <td><?php echo $singleView->gender?></td></tr></li>
                                    <li class="list-group-item"><tr><td>Address:</td> <td><?php echo $singleView->address?></td></tr></li>
                                    <li class="list-group-item"><tr><td>Date:</td> <td><?php echo $singleView->release_date?></td></tr></li>
                                    <li class="list-group-item"><tr><td>Station Name:</td> <td><?php echo $singleView->station_name ?></td></tr></li>
                                </ul>
                            </div>
                        </div>
                    </div>
