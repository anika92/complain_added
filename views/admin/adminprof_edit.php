...
$profile =new RegAdmin();
$a_profile=$profile->prepare($_GET)->adminprofview();
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <form class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post" action="adminprof_store.php"><div class="title"><h2>Admin Registration</h2></div>
                    <input style="display: none" class="large" type="text" name="id" value="<?php echo $a_profile->id ?>""/>
                    <div class="element-input">
                        <label class="title"></label>
                        <div class="item-cont">
                            <input class="large" type="text" name="name" value="<?php echo $a_profile->name ?>""/>
                    ...
                    <div class="element-email">
                        <label class="title"><span class="required">*</span>
                            ...
                            <input class="large" type="email" name="email" value="<?php echo $a_profile->email ?>" />
                            <span class="icon-place"></span>
                        </div>
                    </div>
                    <div class="element-password">
                        <label class="title">
                            ...
                            <input class="large" name="password" type="password" value=""/>
                            <span class="icon-place"></span>
                        </div>
                    </div>
