...
//Utility::dd($itemPerPage);
    ...
    for($i=1;$i<=$totalPage;$i++){
        ...
        $pagination.="<li class='$class'><a href='missingall.php?pageNumber=$i'>$i</a></li>";
    }

    $pageStartFrom=$itemPerPage*($pageNumber-1);
    $allmiss=$miss->paginator($pageStartFrom,$itemPerPage);
            ...
            <section class="content">
                `                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">All Missing List</h3>
                    </div>
                    <form role="form">
                    ...
                    <div class="box-body">
                        <table id="usertable" class="table table-bordered table-striped">
                            ...
                            <?php
                            foreach($allmiss as $info){

                                ?>

                                <tr>
                                    <td><img src="../../Resources/images/missing_persons/<?php echo $info->image ?>" alt="image" height="100px" width="100px"/></td>
                                    <td><?php echo $info->missing_name ?></td>
                                    ...
                                    <td>
                                        <a href="missing_view.php?id=<?php echo $info->missing_id ?>" class="btn bg-navy" role="button">View</a>
                                        <a href="missing_edit.php?id=<?php echo $info->missing_id ?>" class="btn bg-teal" role="button">Edit</a>
                                        <a href="delete.php?id=<?php echo $info->missing_id ?>" class="btn btn-danger" role="button">Delete</a>
                                    </td>
                                </tr>
                                <?php
                            }
                    ...
                    <ul class="pagination">
                        <?php if($pageNumber>1){?>
                            <li><a href="missingall.php?pageNumber=<?php echo $pageNumber-1?>">Prev</a></li><?php };?>
                        <?php echo $pagination?>
                        <?php if($pageNumber<$totalPage){?>
                            <li><a href="missingall.php?pageNumber=<?php echo $pageNumber+1?>">Next</a></li><?php };?>
                    </ul>
                </div>
