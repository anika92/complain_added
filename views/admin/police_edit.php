    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <form class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post" action="police_update.php"><div class="title"><h2>Edit Police Info</h2></div>
                    <input style="display: none;" class="large" type="text" name="id" value="<?php echo $singleView->p_id ?>"/>
                    <div class="element-input">
                        <label class="title"></label>
                        <div class="item-cont">
                            <input class="large" type="text" name="name" value="<?php echo $singleView->name ?>"/>
                    ...
                    <div class="element-email">
                        <label class="title"><span class="required">*</span>
                            ...
                            <input class="large" type="email" name="email" value="<?php echo $singleView->email ?>"  />
                            <span class="icon-place"></span>
                        </div>
                    </div>
                    ...
                    <div class="element-input">
                        <label class="title"></label>
                        <div class="item-cont">
                            <input class="large" type="text" name="police_code" value="<?php echo $singleView->police_code ?>"/>
                            <span class="icon-place"></span>
                        </div>
                    </div>
                    ...
                    <div class="element-input">
                        <label class="title"></label>
                        <div class="item-cont">
                            <input class="large" type="text" name="nid" value="<?php echo $singleView->nid ?>"/>
                            <span class="icon-place"></span>
                        </div>
                    </div>
                    <div class="element-select">
                        ...
                        <div class="item-cont"><span>
                            <select name="status">
                                <option value="Active" <?php if("Active"==$singleView->status) echo "selected" ?>>Active</option>
                                <option value="Suspended" <?php if("Suspended"==$singleView->status) echo "selected" ?>>Suspended</option>
                                <option value="Retired" <?php if("Retired"==$singleView->status) echo "selected" ?>>Retired</option>
