...
if($status == TRUE) {
    ...
    $police=$profile->prepare($_GET)->policeview();
            ...
            <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <div class="thumbnail">
                                <img class="img-responsive" src="../../Resources/images/polices/<?php echo $police->image?>" alt="" height="200px" width="200px">

                                <div class="caption">
                                    <ul class="list-group">
                                        <li class="list-group-item"><h3>Name : <?php echo $police->name?></h3></li>
                                        <li class="list-group-item">Email : <?php echo $police->email?></li>
                                        <li class="list-group-item">NID : <?php echo $police->nid?></li>
                                        <li class="list-group-item">Designation : <?php echo $police->designation?></li>
                                        <li class="list-group-item">Thana/PS : <?php echo $police->thana?></li>
                                        <li class="list-group-item">City : <?php echo $police->city?></li>
                                        <li class="list-group-item">Address : <?php echo $police->address?></li>
                                        <li class="list-group-item">Postal : <?php echo $police->postal?></li>
                                        <li class="list-group-item">Gender : <?php echo $police->gender?></li>
                                        <li class="list-group-item">Phone : <?php echo $police->phone?></li>
                                        <li class="list-group-item">Status : <?php echo $police->status?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
