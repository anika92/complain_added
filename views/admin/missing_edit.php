    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <form class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post"  action="missing_update.php" enctype="multipart/form-data"><div class="title"><h2>Edit Missing Persons Info</h2></div>
                    <br />

                    <input style="display: none;" class="large" type="text" name="id" value="<?php echo $singleView->missing_id  ?>"/>
                    ...
                    <div class="element-input">
                        ...
                        <div class="item-cont">
                            <input class="large" type="text" name="name" value="<?php echo $singleView->missing_name  ?>"/>
                    ...
                    <div class="element-textarea">
                        <label class="title"></label>
                        <div class="item-cont">
                            <textarea class="medium" name="description" cols="20" rows="5"><?php echo $singleView->description ?></textarea>
                            <span class="icon-place"></span>
                        </div>
                    </div>
                    <div class="element-input">
                    ...
                    <div class="element-textarea">
                        <label class="title"></label>
                        <div class="item-cont">
                            <textarea class="medium" name="address" cols="20" rows="5"><?php echo $singleView->address ?></textarea>
                            <span class="icon-place"></span>
                        </div>
                    </div>
                    ...
                    <div class="element-phone">
                        <label class="title"></label>
                        <div class="item-cont">
                            <input class="large" type="number" pattern="[+]?[\.\s\-\(\)\*\#0-9]{3,}" name="phone" value="<?php echo $singleView->contact ?>"/>
                            <span class="icon-place"></span>
                        </div>
                    </div>
                    <div class="element-date">
                        <label class="title"></label>
                        <div class="item-cont">
                            <input class="large" type="text" name="date1" value="<?php echo $singleView->date ?>"/>
                            <span class="icon-place"></span>
                        </div>
                    </div>
                    <div class="element-date"><label class="title"></label><div class="item-cont"><input class="large" data-format="yyyy-mm-dd" type="date" name="date" value="<?php echo $singleView->date?>"/><span class="icon-place"></span></div></div>
                    <div class="element-select">
                        <label class="title"></label>
                        <div class="item-cont"><span>
                            <select name="status">
                                <option value="Still Missing" <?php if("Still Missing"==$singleView->status) echo "selected" ?>>Still Missing</option>
                                <option value="Found" <?php if("Found"==$singleView->status) echo "selected" ?>>Found</option>
                            </select><i></i><span class="icon-place"></span></span>
                        </div>
                    </div>
                    <div class="submit"><input type="submit" value="Submit"/></div></form><p class="frmd"><a href="http://formoid.com/v29.php">form html</a> Formoid.com 2.9</p><script type="text/javascript" src="../../Resources/formoid_files/formoid1/formoid-solid-blue.js"></script>
                <!-- Stop Formoid form-->
